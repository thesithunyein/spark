...
reason is exact: **all 46 on-chain events were produced by a single wallet.** That number is
public and stays public, because the alternative — wallets we control wearing different hats —
would be worse than admitting the weakness.
