...
export function SuccessBanner({
  ...
  return (
    <div className="card-hover anim anim-scale-in border border-success/30 bg-success/10 p-4">
      <div className="flex items-start gap-3">
        <span className="anim anim-scale-in flex h-8 w-8 shrink-0 items-center justify-center bg-success/20 text-success">
